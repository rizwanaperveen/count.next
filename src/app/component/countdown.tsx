...
/**
 * Countdown is a React component that renders a countdown timer UI. It allows
 * the user to set the duration of the countdown and start, pause, and reset the
 * timer.
 *
 * The component uses the useState hook to manage the countdown timer value and
 * the useEffect hook to manage the countdown interval. The component also uses
 * the useRef hook to store the timer ID.
 *
 * The component renders a container div with a timer box container, input and
 * set button container, display of the formatted time left, and buttons to start,
 ...
 */  // State to manage the duration input
  ...
  return (
    ...
    <div className="flex flex-col items-center justify-center h-screen bg-gradient-to-r from-indigo-500 via-purple-100 dark:bg-gray-900">
      {/* Timer box container */}
      <div className=" dark:bg-gray-800 shadow-lg rounded-lg p-8 w-full max-w-md">
        {/* Title of the countdown timer */}
        <h1 className="text-3xl font-bold mb-4 text-gray-900 dark:text-gray-200 text-center">
          Countdown Timer
        </h1>
        ...
        <div className="flex items-center mb-6">
          <Input
            ...
            className="flex-1 mr-4 rounded-md border-gray-500 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200"
          />
          <Button
            onClick={handleSetDuration}
            variant="outline"
            className="text-black font-bold dark:text-gray-200 bg-slate-500"
          >
            Set
          </Button>
        </div>
        {/* Display the formatted time left */}
        <div className="text-6xl font-bold text-gray-950 dark:text-gray-200 mb-8 text-center bg-orange-300">
          {formatTime(timeLeft)}
        </div>
        ...
        <div className="flex justify-center gap-4">
          <Button
            onClick={handleStart}
            variant="outline"
            className="text-black font-bold dark:text-gray-200 bg-transparent hover:bg-orange-300"
          >
          ...
          <Button
            onClick={handleReset}
            variant="outline"
            className="text-black font-bold dark:text-gray-200 hover:bg-orange-300 ]"
          >
            Reset
          </Button>
        </div>
